<template>
  <div class="master">
    <div class="create_dialog">
      <el-button type="primary" @click="handleInsert">新建品牌</el-button>
    </div>

    <el-table ref="multipleTableRef" :data="useRetailStore.brands" style="width: 100%">
...
import { Brand } from '@/common/entity'
...
const submitCallback = (data: any) => {
  useRetailStore.brands.length = 0
  data.forEach((brand: Brand) => {
    useRetailStore.brands.push(brand)
  })
  dialogFormVisible.value = false
}
